/**Dialogue-based Game "The Night"
    ...
    This document is used when the platform RASA is unreachable.
    ...
    states: {
        ...
        choice: {
            on: {
                ...
                {
                    cond: (context) => "party" in (dict[context.recResult] || {}),
                    target: "party"
                },
                {
...
//Previous dict to use if problems with nlu data.
const dict: { [index: string]: { sleep?: string, work?: string, call?: string, party?: string, help?: string, agree?: string, refuse?: string } } = {
    ...
    "calling mom": { call: "call" },
    "calling": { call: "call" },
    "call my mother": { call: "call" },
    "call my mum": { call: "call" },
    "I want to call": { call: "call" },
    "I'm gonna call": { call: "call" },
    "I'm going to call my mother": { call: "call" },
    "I will call my mother": { call: "call" },
    "I need to call my mum": { call: "call" },
    "call maman": { call: "call" },
    "I should call my mother": { call: "call" },
    "I wonder how is mom": { call: "call" },
